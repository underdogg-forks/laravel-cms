...
var app = new Vue({
    mixins: [require('./bootstrap')]
});

},{"./bootstrap":5,"vue":3}],5:[function(require,module,exports){
'use strict';
...
},{"./login":6,"vue":3,"vue-resource":2}],6:[function(require,module,exports){
'use strict';
    ...
    methods: {
        submit: function submit() {
            ...
            if (this.model.username == '') {
                this.modelErrors.username = true;
            }

            if (this.model.password == '') {
                this.modelErrors.password = true;
            }
